...
module.exports = function (context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('extension.vx.showWelcome', function (uri) {
        ...
        panel.webview.html = getWebViewContent(context, 'src/view/vx-wel/index.html');
    ...
    const key = 'wjCodeParams.showTip';
    // 如果设置里面开启了欢迎页显示，启动欢迎页
    if (vscode.workspace.getConfiguration().get(key)) {
        vscode.commands.executeCommand('extension.vx.showWelcome');
    }
};
